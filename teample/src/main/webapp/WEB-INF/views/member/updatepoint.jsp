...
<link rel="stylesheet" href="../resources/css/join.css?v=3">
...
<c:if test="${alert!=null }">
	<script type="text/javascript">
 	...
 	<div style="width: 70%; margin: auto;">
                ...
                <td>포인트 충전</td>
                <form action="updatepoint" name="frmReg" method="post" onsubmit="return validCheck()">
				<input type="hidden" name="idx" value="${member.idx}" >  
					<tr>
					<td>보유 포인트 : ${member.point }</td> 
					</tr>
				<tr>
